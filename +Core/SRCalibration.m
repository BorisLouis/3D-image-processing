classdef SRCalibration < handle
    ...
    methods
        ...
        function retrieveSRCalData(obj,detectParam, trackParam,q)
            ...
            %Checking user input
            assert(nargin==4, 'retrieveSRCalData expects 4 inputs, 1)detection Parameters, fit z parameter, tracking parameter, channel');
            ...
            for i = 1: nfields
                ...
                [SRCalibData,dataPerPlane] = currMov.getSRCalData(trackParam,q);
        ...
        function [transMat,corrData] = corrTranslation(obj,refPlane,q)
        ...
        function [rotMat,corrData] = corrRotation(obj,refPlane,q)
