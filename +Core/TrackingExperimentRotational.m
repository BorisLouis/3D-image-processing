        ...
        function ConsolidateChannels3(obj)
            ...
            for i = 1:numTraces1
                ...
                for j = 1:numTraces2
                    ...
                    coords2 = Transformation.Coords2toCoords1.b*coords2*Transformation.Coords2toCoords1.T + Transformation.Coords2toCoords1.c;
            ...
            [closest_indices, ~] = matchpairs(distances, 10000);
