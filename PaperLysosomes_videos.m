...
nFrames = [1000, 1000, 1000, 200, 300, 300, 300, 300, 300, 300];
ExpTimes = [30, 30, 30, 200, 100, 100, 100, 100, 100, 100];
CellNames = {'A549 - mSi', 'A549 - mSiPEI', 'HeLa - mSi', 'HeLa - mSiPEI', 'HepG2 - mSi', 'HepG2 - mSiPEI',...
    'KM12C - mSi', 'KM12C - mSiPEI', 'MCF - mSi', 'MCF - mSiPEI'};
imgH = 512;
imgW = 512;
...
for s = 3:size(HeadFolders,1)
    ...
    framesToLoad = 1:nFrames(s);
    frameRate = ExpTimes(s);     % frames per second
    ...
    mainFolder1 = 'D:\MultiColor - lysosome tracking\raw data for presentation\A549mSi_15_30ms';
    videoFile1  = fullfile(mainFolder1,'calibrated2','calibratedPlane2.tif');
