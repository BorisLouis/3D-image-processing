function [ ROI ] = defineROI( chaWin, chC1, chC2, chC3, chC4, im_size )
%DEFINEROI define ROIs in the cameras for multiplane experiments
    ...
    cornerC3 = round(chC3 - chaDel);
    cornerC4 = round(chC4 - chaDel);
    ROI(:,1:2) = cat(1,cornerC1,cornerC2, cornerC3, cornerC4);
    ROI(:,3) = chaWin(1);
    ROI(:,4) = chaWin(2);
    x1 = ROI(:,1);
    x2 = x1+chaWin(1)-1;
